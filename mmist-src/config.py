...
def create_arg_parser():
    ...
    parser.add_argument('--ablation_mode', default='CT_WSI_Clinical', type=str, help='Ablation combination: CT, WSI, Clinical, CT_WSI, CT_Clinical, WSI_Clinical, CT_WSI_Clinical')
    ...
    parser.add_argument('--integration_method', default='MAM_G', type=str, help='concat, G, MAM_G')
    parser.add_argument('--max_seq_len_agg', default=1024, type=int, help='Max tokens per modality before aggregator (prevents OOM for G/MAM_G)')
    ...
    parser.add_argument('--pretrainedExt_CT_pth', type=str, default='/mnt/KW/LungCancer/Multimodality/results/SavedModels/modality(1)/stage_tr(1234)/norm_[2.0,2.0,2.5]/mask(X)/crop(X)/2023-12-18-15:44:18/checkpoint_0901.pt')
    parser.add_argument('--pretrainedExt_pathology', type=int, default=1)
    # parser.add_argument('--pretrainedExt_pathology_pth', type=str, default='/mnt/KW/LungCancer/Multimodality/results/SavedModels/EUMC+HUMC+SCHMC/modality(2)/stage_tr(1234)/ABMIL_v2/norm_[2.0,2.0,2.5]/2024-01-30-14:07:36/checkpoint_0009.pt')
    parser.add_argument('--pretrainedExt_pathology_pth', type=str, default='/mnt/KW/LungCancer/Multimodality/results/SavedModels/EUMC+HUMC+SCHMC/modality(2)/stage_tr(1234)/ABMIL_v2/norm_[2.0,2.0,2.5]/2024-01-30-14:07:36/checkpoint_0009.pt')
    parser.add_argument('--pretrainedExt_CI', type=int, default=1)
    parser.add_argument('--pretrainedExt_CI_pth', type=str, default='/mnt/KW/LungCancer/Multimodality/results/SavedModels/EUMC+HUMC+SCHMC/modality(3)/stage_tr(1234)/simpleFCs_v2/norm_[2.0,2.0,2.5]/2024-01-31-07:27:00/checkpoint_0473.pt')
